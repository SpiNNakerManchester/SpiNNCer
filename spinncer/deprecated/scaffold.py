...
DELAY = 0.2
setup(timestep=DELAY, min_delay=DELAY, max_delay=DELAY + 99)
...
stimulus = Population(pop_gr.size, SpikeSourceArray(spike_times=stim_array_int))
...
Projection(stimulus, pop_gr, OneToOneConnector(), ss)
